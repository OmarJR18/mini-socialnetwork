...
int main()
{
    std::cout << "=== Prueba de LinkedList<int> ===" << std::endl;
    LinkedList<int> list;
    ...
    std::cout << "Eliminando 10: " << (list.remove_item(10) ? "si" : "no") << std::endl;
    std::cout << "Primer elemento: " << list.at(0) << std::endl;

    LinkedList<int> copy(list);
    std::cout << "Copia, tamaño: " << copy.size() << std::endl;

    std::cout << "\n=== Prueba de LinkedList<Person> ===" << std::endl;
